...
/* 활성 탭 버튼 */
.tab-btn.active {
	background: #fff; /* 활성화된 버튼 배경색 설정 */
	color: #0d6efd; /* 활성화된 버튼 글자 색상 설정 */
	font-weight: bold; /* 글꼴 두께 설정 */
	border-color: #ccc; /* 활성화된 버튼 경계 색상 설정 */
	...
	<div class="content">
		...
		<div id="edit" style="display: flex; flex-direction: column;">
			...
			<div class="form-section">
				<input type="text" placeholder="닉네임" readonly /> <input type="text"
					placeholder="아이디" readonly /> <input type="text" placeholder="이메일"
					readonly /> <input type="text" placeholder="성년월일" readonly />
			</div>
		</div>
		<!-- 나의활동내역 섹션 -->
