...
<body>
	...
	//평점 평균
	double avgStars = dao.getAverageStars();
	//평점 갯수
	...
	<div class="custom-content-wrapper">
		<div class="summary">
			<div>
				<strong>##휴게소 평균 평점</strong> <span class="star">★</span> <strong><%=String.format("%.1f", avgStars)%></strong>
		...
		<form action="<%=request.getContextPath()%>/gpa/gpaAction.jsp"
				...
				<table>
					...
					<tbody>
						<tr style="height: 50px;">
							...
							<td
								style="text-align: center; vertical-align: middle; white-space: nowrap;">아이디</td>
							<td
								style="text-align: center; vertical-align: middle; white-space: nowrap;">닉네임</td>
							<td><textarea name="content" class="form-control"
									style="width: 100%; height: 100%; resize: vertical;"
									placeholder="후기를 입력해주세요..." required></textarea></td>
						</tr>
					</tbody>
				</table>
			...
			<div class="review-button-container">
				<button id="reviewWriteBtn" class="btn btn-primary review-write-btn"
					type="button" onclick="toggleReviewForm()">✍️ 후기 작성</button>
			</div>
		</form>
	</div>
